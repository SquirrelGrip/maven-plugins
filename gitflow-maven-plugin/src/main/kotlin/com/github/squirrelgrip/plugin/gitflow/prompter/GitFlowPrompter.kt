...
interface GitFlowPrompter {
     ...
     */
    fun prompt(choices: Array<String>, defaultChoice: String?, preMessage: String = "", postMessage: String = ""): String
     ...
     * @return Response obtained from prompting.
     */
    fun prompt(message: String = "", validation: PromptValidation<String>): String
     ...
     */
    fun prompt(message: String = "", choices: List<String> = emptyList()): String
}
